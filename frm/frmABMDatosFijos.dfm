object fAbmDatosFijos: TfAbmDatosFijos
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = 'Archivos - Datos Fijos'
  ClientHeight = 397
  ClientWidth = 793
  Color = clSilver
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    object TodosAfecta: TCheckBox
      ...
      State = cbChecked
      TabOrder = 6
      OnClick = TodosAfectaClick
    end
    object TodosDestino: TCheckBox
      Left = 552
      Top = 34
      Width = 52
      Height = 16
      ...
      State = cbChecked
      TabOrder = 8
      OnClick = TodosDestinoClick
    end
    object chInactivos: TCheckBox
      Left = 436
      Top = 54
      Width = 105
      Height = 16
    ...
    object chSoloInactivos: TCheckBox
      Left = 305
      Top = 54
      Width = 105
      Height = 16
      Caption = 'Ver solo Inactivos'
      TabOrder = 11
    end
  end
