...
uses
  ...
  ABMActualizacionValores, ABMImpuestosPagados;
...
// 24/06/2012
  ...
  try
    ...
    begin
      ...
      begin
        Sql.Add('Select * from contratos where codinq = :Codinq');
...
begin
  ...
  fABMImpuestosPagados.PantallaActiva := paDevolverDinero;
  fABMImpuestosPagados.Caption := 'Devolver dinero a caja';
end;
