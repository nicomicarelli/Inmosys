object fInformeImpuestosPagados: TfInformeImpuestosPagados
  Left = 621
  Top = 173
  BorderStyle = bsSingle
  Caption = 'Informe Impuestos Automatizados vs Cobrados'
  ClientHeight = 471
  ClientWidth = 885
  Color = clWhite
  ...
  object qVales: TFXQuery
    ...
    SQL.Strings = (
      ...
      '  and cerrado = 0'
      'Order by Codigoempresa, Codigo desc')
    Left = 791
    Top = 166
    ParamData = <
      item
