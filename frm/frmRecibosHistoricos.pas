...
type
  TfRecibosHistoricos = class(TForm)
...
var
  fRecibosHistoricos: TfRecibosHistoricos;
  fRecibosAnomalias: TfRecibosHistoricos;
...
procedure TfRecibosHistoricos.ActualizarClick(Sender: TObject);
var
  q: tFXQuery;
  I: Integer;
begin
  ...
  try
    ...
    begin
      q.SQL.Add(' and R.Codinq >=:desdec and R.Codinq <=:HastaC ');
      q.ParamByName('DesdeC').AsString := FormatFloat('0000', ToFloat(edDesde.Text));
      q.ParamByName('HastaC').AsString := FormatFloat('0000', ToFloat(edHasta.Text));
    end;
...
function TfRecibosHistoricos.TituloGetFieldValue(aFieldName: string): Variant;
begin
(*
...
procedure TfRecibosHistoricos.TodosAfectaClick(Sender: TObject);
begin
(*
  if todosAfecta.Checked then
...
procedure TfRecibosHistoricos.TodosClick(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.TodosCodigosClick(Sender: TObject);
begin
  if todosCodigos.Checked then
  begin
    edDesde.Text:='';
...
procedure TfRecibosHistoricos.TodosDescripcionClick(Sender: TObject);
begin
(*
  if todosDescripcion.Checked then
    edDescripcion.Text:='';
...
procedure TfRecibosHistoricos.TodosDestinoClick(Sender: TObject);
begin
(*
  if todosDestino.Checked then
...
procedure TfRecibosHistoricos.btnEliminarClick(Sender: TObject);
var
  Codinq: string;
  Tipo: string;
  Letra: string;
...
procedure TfRecibosHistoricos.btnImprimirClick(Sender: TObject);
var
...
procedure TfRecibosHistoricos.btnModificarClick(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.btnNuevoClick(Sender: TObject);
begin
  if FDatosFijos = nil then
    Application.CreateForm(TFDatosFijos, FDatosFijos)
  else
...
procedure TfRecibosHistoricos.btnSalirClick(Sender: TObject);
begin
  Close;
end;

procedure TfRecibosHistoricos.cbAfectaClick(Sender: TObject);
begin
//  todosafecta.Checked := False;
end;

procedure TfRecibosHistoricos.cbDestinoChange(Sender: TObject);
begin
//  TodosDestino.Checked := False;
end;

procedure TfRecibosHistoricos.cbTipoClick(Sender: TObject);
begin
  if cbTipo.ItemIndex = 1 then
  begin
    cbLetra.Items.Clear;
...
procedure TfRecibosHistoricos.TodosPropietariosClick(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.edDescripcionChange(Sender: TObject);
begin
(*
...
procedure TfRecibosHistoricos.edDesdeChange(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.edDesdeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
//  edHasta.Text := edDesde.text;
end;
...
procedure TfRecibosHistoricos.edDesdeKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfRecibosHistoricos.edHastaChange(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
  if not (key in ['0'..'9',#8]) then
    Key := #0;
end;

procedure TfRecibosHistoricos.Edit6Change(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.Edit6KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
...
procedure TfRecibosHistoricos.Edit8Change(Sender: TObject);
begin
  if edit8.Text <> '' then
    todos.Checked:=False
  else
...
procedure TfRecibosHistoricos.Edit8KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
...
procedure TfRecibosHistoricos.edPropietarioChange(Sender: TObject);
begin
  todosPropietarios.Checked:=edPropietario.Text = '';
end;

procedure TfRecibosHistoricos.EliminarRecibo1Click(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  ...
  action := caFree;
  if Assigned(FRecibosHistoricos) then
    fRecibosHistoricos := nil;
  if Assigned(FRecibosAnomalias) then
    fRecibosAnomalias := nil;
end;

procedure TfRecibosHistoricos.FormCreate(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.gDetalleClick(Sender: TObject);
var
  q: tFXQuery;
  I: Integer;
begin
...
procedure TfRecibosHistoricos.gDetalleDblClick(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.gDetalleFixedColClick(Sender: TObject; col: Integer);
begin
  if col = 0 then
...
procedure TfRecibosHistoricos.Marcarcomopendientederetirar1Click(
  Sender: TObject);
var
  q: TFXQuery;
begin
...
procedure TfRecibosHistoricos.Marcarcomoretirada1Click(Sender: TObject);
var
  q: TFXQuery;
begin
  q := CrearQuery;
...
function TfRecibosHistoricos.plTituloGetFieldValue(aFieldName: string): Variant;
begin
...
procedure TfRecibosHistoricos.popEliminarPopup(Sender: TObject);
begin
...
procedure TfRecibosHistoricos.ReciboControlado1Click(Sender: TObject);
var
  q: TFXQuery;
begin
  if gDetalle.Cells[0, gDetalle.Row] = '' then
