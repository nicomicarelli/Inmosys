...
type
  TFActualizacionValores = class(TForm)
...
var
  FActualizacionValores: TFActualizacionValores;
...
procedure TFActualizacionValores.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
  fActualizacionValores := nil;
end;

procedure TFActualizacionValores.FormCreate(Sender: TObject);
begin
...
procedure TFActualizacionValores.gDetalleEditCellDone(Sender: TObject; ACol,
  ARow: Integer);
begin
  if ACol = 5 then
  begin
...
procedure TFActualizacionValores.gDetalleGetAlignment(Sender: TObject; ARow,
...
procedure TFActualizacionValores.gDetalleKeyPress(Sender: TObject; var Key: Char);
var
  stCodigo: string;
begin
...
procedure TFActualizacionValores.gDetalleSearchFooterAction(Sender: TObject;
  Value: string; ACol, ARow: Integer; SearchAction: TSearchAction);
begin
  gDetalle.EditCell(gDetalle.Col, gDetalle.Row);
end;

procedure TFActualizacionValores.prInterpretarCodigoBarras(Fila: Integer; ATexto: String);
begin
...
procedure TFActualizacionValores.SeleccionarTodos1Click(Sender: TObject);
var
  I: Integer;
begin
...
procedure TFActualizacionValores.actGrabarExecute(Sender: TObject);
var
  Codigo: string;
  Descripcion: string;
  Mes: string;
  ...
  try
    try
      ...
      begin
        ...
        ValorInquilino :=ToFloat(gDetalle.Cells[6,I]);
        ValorPropietario :=ToFloat(gDetalle.Cells[8,I]);

        if Trim(gDetalle.Cells[2, I]) <> '' then
        begin
          if ActualizaAutomatizacion and (gDetalle.GetCheckboxState(0,I,Estado)) and (Estado) then
          begin
            if (ToFloat(gDetalle.Cells[4,I]) = 0) and (ToFloat(gDetalle.Cells[5,I]) = 0) then
              Continue;
            ...
            begin
              ...
              begin
                ...
                qAutomatizacion.ParamByName('DGR9').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[4, I]));
              ...
              begin
                ...
                qAutomatizacion.ParamByName('DGR4').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[4, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
              if Es27 then
              begin
                ...
                qAutomatizacion.ParamByName('DGR27').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[5, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
            end;
            ...
            begin
              ...
              begin
                ...
                qAutomatizacion.ParamByName('AGUA9').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[4, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
              if Es2 then
              begin
                ...
                qAutomatizacion.ParamByName('AGUA2').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[4, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
              if Es27 then
              begin
                ...
                qAutomatizacion.ParamByName('AGUA27').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[5, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
            end;
            ...
            begin
              ...
              begin
                ...
                qAutomatizacion.ParamByName('MUNI9').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[4, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
              if Es5 then
              begin
                ...
                qAutomatizacion.ParamByName('MUNI5').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[4, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
              if Es27 then
              begin
                ...
                qAutomatizacion.ParamByName('MUNI27').AsString := FormatFloat('0.00', ToFloat(gDetalle.Cells[5, I]));
                qAutomatizacion.ParamByName('Codinq').AsString := gDetalle.Cells[1, I];
                qAutomatizacion.ExecSQL;
              end;
            end;
...
procedure TFActualizacionValores.ActualizarClick(Sender: TObject);
var
  q: TFXQuery;
  I: Integer;
  pCodigo: string;
begin
  ...
  try
    ...
    begin
      ...
      begin
        q.Sql.Text :=
          ' Select I.Codinq, I.Inquilino, I.Propietario, A.DGR9 as Codigo9, A.DGR4 as CodigoX, A.DGR27 as Codigo27, C.ImporteInquilino, C.ImportePropietario, C.FechaPago ' +
          '   from Inmuebles I' +
      ...
      begin
        q.Sql.Text :=
          ' Select I.Codinq, I.Inquilino, I.Propietario, A.Agua9 as Codigo9, A.Agua2 as CodigoX, A.Agua27 as Codigo27, C.ImporteInquilino, C.ImportePropietario, C.FechaPago ' +
          '   from Inmuebles I' +
          '  Inner Join Automatizacion A on A.Codinq = I.Codinq ' +
          '  Inner Join CuerpoCedulones C on C.Codinq = I.Codinq ' +
          '  Where C.Codigo = :Codigo ' +
      ...
      begin
        q.Sql.Text :=
          ' Select I.Codinq, I.Inquilino, I.Propietario, A.Muni9 as Codigo9, A.Muni5 as CodigoX, A.Muni27 as Codigo27,  C.ImporteInquilino, C.ImportePropietario, C.FechaPago ' +
          '   from Inmuebles I' +
          '  Inner Join Automatizacion A on A.Codinq = I.Codinq ' +
          '  Inner Join CuerpoCedulones C on C.Codinq = I.Codinq ' +
          '  Where C.Codigo = :Codigo ' +
    ...
    begin
      ...
      q.Sql.Text :=
        ' Select I.Codinq, I.Inquilino, C.PorcentajeInquilino, C.PorcentajePropietario, C.Vencimiento, C.FechaPago, C.Importe, C.Cuenta, C.ImportePropietario, C.ImporteInquilino ' +
        '   from Inmuebles I' +
        '  Inner Join CuerpoCedulones C on C.Codinq = I.Codinq ' +
        '  where C.Codigo = :Codigo '+
        '    and C.Mes = :Mes '+
...
procedure TFActualizacionValores.AdvGlowButton1Click(Sender: TObject);
begin
...
procedure TFActualizacionValores.BorrarCeduln1Click(Sender: TObject);
begin
...
procedure TFActualizacionValores.DatosKeyPress(Sender: TObject; var Key: Char);
begin
(*  q := CrearQuery;
  try
...
procedure TFActualizacionValores.DeseleccionarTodos1Click(Sender: TObject);
var
  I: Integer;
begin
  for I := 1 to gDetalle.RowCount - 1 do
...
procedure TFActualizacionValores.edEmpresaClick(Sender: TObject);
var
  q: TFXQuery;
begin
  q := CrearQuery;
...
procedure TFActualizacionValores.edtCodigoKeyPress(Sender: TObject; var Key: Char);
begin
//  if Key = #13 then
//    edtDescripcion.SetFocus;
end;

procedure TFActualizacionValores.actBorrarUpdate(Sender: TObject);
begin
//  actBorrar.Enabled := (Trim(edtCodigo.Text) <> '');
end;

procedure TFActualizacionValores.btnSalirClick(Sender: TObject);
begin
  Close;
end;

procedure TFActualizacionValores.Cargar(pCodigo: string; Operacion: TTipoOperacion; Mes: string = 'ENERO'; Anio: string = '2015'; Cuota50: string = 'SI'; boEsCopia: Boolean = False);
var
  q: TFXQuery;
  I: Integer;
begin
