object fHistorialPagoInquilinos: TfHistorialPagoInquilinos
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = 'Cuentas Corrientes - Historial de Pago de Inquilinos'
  ClientHeight = 351
  ClientWidth = 944
  Color = clSilver
  ...
  object Panel3: TPanel
    ...
    object Label5: TLabel
      ...
      Width = 92
      Height = 13
      Caption = 'Item con anomal'#237'as'
    end
  ...
  object Reporte: TppReport
    ...
    object ppTitleBand1: TppTitleBand
      ...
      object ppLabel1: TppLabel
        ...
        UserName = 'Label1'
        AutoSize = False
        Caption = 'Historial de Pago de Inquilinos'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
  ...
  object plReporte: TppJITPipeline
    ...
    object plReporteppField5: TppField
      FieldAlias = 'Fecha Pago'
      FieldName = 'Fecha Pago'
      FieldLength = 10
      DisplayWidth = 10
      Position = 7
    end
