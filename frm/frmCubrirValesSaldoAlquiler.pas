unit frmCubrirValesSaldoAlquiler;
...
type
  TfCubrirValesSaldoAlquiler = class(TForm)
...
var
  fCubrirValesSaldoAlquiler: TfCubrirValesSaldoAlquiler;
...
procedure TfCubrirValesSaldoAlquiler.ActualizarClick(Sender: TObject);
var
  q: tFXQuery;
  I: Integer;
begin
...
function TfCubrirValesSaldoAlquiler.TituloGetFieldValue(aFieldName: string): Variant;
begin
(*
...
procedure TfCubrirValesSaldoAlquiler.TodosAfectaClick(Sender: TObject);
begin
(*
  if todosAfecta.Checked then
...
procedure TfCubrirValesSaldoAlquiler.TodosClick(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.TodosCodigosClick(Sender: TObject);
begin
  if todosCodigos.Checked then
  begin
    edDesde.Text:='';
...
procedure TfCubrirValesSaldoAlquiler.TodosDescripcionClick(Sender: TObject);
begin
(*
  if todosDescripcion.Checked then
    edDescripcion.Text:='';
...
procedure TfCubrirValesSaldoAlquiler.TodosDestinoClick(Sender: TObject);
begin
(*
  if todosDestino.Checked then
...
procedure TfCubrirValesSaldoAlquiler.btnEliminarClick(Sender: TObject);
var
  Codinq: string;
  Tipo: string;
  Letra: string;
...
procedure TfCubrirValesSaldoAlquiler.btnImprimirClick(Sender: TObject);
var
  niLinea, I,j: Integer;
...
procedure TfCubrirValesSaldoAlquiler.btnNuevoClick(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.btnSalirClick(Sender: TObject);
begin
  Close;
end;

procedure TfCubrirValesSaldoAlquiler.cbAfectaClick(Sender: TObject);
begin
//  todosafecta.Checked := False;
end;

procedure TfCubrirValesSaldoAlquiler.cbDestinoChange(Sender: TObject);
begin
//  TodosDestino.Checked := False;
end;

procedure TfCubrirValesSaldoAlquiler.DeseleccionarTodos1Click(Sender: TObject);
var
  I: Integer;
begin
  for I := 1 to gDetalle.RowCount - 1 do
...
procedure TfCubrirValesSaldoAlquiler.TodosPropietariosClick(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.edDescripcionChange(Sender: TObject);
begin
(*
...
procedure TfCubrirValesSaldoAlquiler.edDesdeChange(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.edDesdeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
//  edHasta.Text := edDesde.text;
end;
...
procedure TfCubrirValesSaldoAlquiler.edDesdeKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfCubrirValesSaldoAlquiler.edHastaChange(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.Edit6Change(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.Edit6KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
...
procedure TfCubrirValesSaldoAlquiler.Edit8Change(Sender: TObject);
begin
  if edit8.Text <> '' then
    todos.Checked:=False
  else
...
procedure TfCubrirValesSaldoAlquiler.Edit8KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
...
procedure TfCubrirValesSaldoAlquiler.edPropietarioChange(Sender: TObject);
begin
  todosPropietarios.Checked:=edPropietario.Text = '';
end;

procedure TfCubrirValesSaldoAlquiler.EliminarRecibo1Click(Sender: TObject);
begin
...
procedure TfCubrirValesSaldoAlquiler.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action := caFree;
  fCubrirValesSaldoAlquiler := nil;
end;
...
procedure TfCubrirValesSaldoAlquiler.gDetalleFixedColClick(Sender: TObject; col: Integer);
begin
  if Col = 0 then
...
procedure TfCubrirValesSaldoAlquiler.SeleccionarTodos1Click(Sender: TObject);
var
  I: Integer;
begin
  for I := 1 to gDetalle.RowCount - 1 do
