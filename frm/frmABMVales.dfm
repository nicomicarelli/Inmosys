object fABMVales: TfABMVales
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = 'ABM de Vales'
  ClientHeight = 431
  ClientWidth = 1002
  Color = clBtnFace
  ...
  object AdvPanel2: TAdvPanel
    ...
    object cxGroupBox1: TcxGroupBox
      ...
      object lbTarea: TcxLabel
        Left = 3
        Top = 7
        Caption = 'Espere, ajustando vales...'
    ...
    object cxGroupBox2: TcxGroupBox
      ...
      object chCerrados: TcxCheckBox
        Left = 399
        Top = 40
        Caption = 'Incluir Cerrados'
        ParentBackground = False
        ParentColor = False
        ParentFont = False
        Style.Color = clBlack
      ...
      object edCodinqDesde: TEdit
        ...
        MaxLength = 4
        TabOrder = 11
        OnChange = edCodinqDesdeChange
      end
      object edCodinqHasta: TEdit
        Left = 623
        Top = 13
        Width = 87
        Height = 21
        ...
        MaxLength = 4
        TabOrder = 12
        OnChange = edCodinqHastaChange
      end
      object chTodosCodinq: TcxCheckBox
        Left = 715
        Top = 11
        Caption = 'Todos'
        ParentBackground = False
        ...
        TabOrder = 13
        Transparent = True
        OnClick = chTodosCodinqClick
        Width = 121
      end
      object chRecuperar: TcxCheckBox
        Left = 700
        Top = 68
        Caption = 'Ver Monto a Recuperar'
        ParentBackground = False
        ParentColor = False
        ParentFont = False
        Style.Color = clBlack
      ...
      object gDatos: TcxGridDBTableView
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            ...
            Kind = skSum
            FieldName = 'Monto'
            Column = Columna_Monto
          end
          item
            Format = '$ ,0.00;$ -,0.00'
            Kind = skSum
            FieldName = 'Pendiente'
            Column = Columna_Pendiente
          end
          item
            Format = '$ ,0.00;$ -,0.00'
            Kind = skSum
            FieldName = 'Recuperar'
            Column = Columna_Recuperar
          end>
        ...
        object Columna_Monto: TcxGridDBColumn
          Caption = 'Monto Generado'
          PropertiesClassName = 'TcxTextEditProperties'
        ...
        object Columna_Recuperar: TcxGridDBColumn
          Caption = 'A Recuperar'
          Visible = False
          HeaderAlignmentHorz = taCenter
          Width = 87
        end
        object Columna_Pendiente: TcxGridDBColumn
          Caption = 'Pendiente a Cubrir'
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taRightJustify
          Properties.ReadOnly = True
          HeaderAlignmentHorz = taCenter
        ...
        object Columna_Mes: TcxGridDBColumn
          Caption = 'Mes'
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.ReadOnly = True
          HeaderAlignmentHorz = taCenter
        ...
        object Columna_Anio: TcxGridDBColumn
          Caption = 'A'#241'o'
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.ReadOnly = True
          HeaderAlignmentHorz = taCenter
        ...
        object Columna_Categoria: TcxGridDBColumn
  ...
  object Reporte: TppReport
    ...
    object ppTitleBand1: TppTitleBand
      ...
      object ppLabel1: TppLabel
        ...
        UserName = 'Label1'
        AutoSize = False
        Caption = 'Listado de Categorias de vales'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
  ...
  object popEliminar: TPopupMenu
    ...
    object GenerarMovimientoenlaCaja1: TMenuItem
      Caption = 'Nuevo Vale Copia del Seleccionado'
      OnClick = GenerarMovimientoenlaCaja1Click
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object NuevoValecopiaFIELdelSeleccionado1: TMenuItem
      Caption = 'Nuevo Vale copia FIEL del Seleccionado'
      OnClick = NuevoValecopiaFIELdelSeleccionado1Click
    end
    object N2: TMenuItem
      Caption = '-'
    end
    object NuevoValeCOPIALIMPIA1: TMenuItem
      Caption = 'Nuevo Vale COPIA LIMPIA'
      OnClick = NuevoValeCOPIALIMPIA1Click
    end
  end
end
