object fAnomalias: TfAnomalias
  ...
  object gAnomalias: TStringAlignGrid
    Left = 0
    Top = 306
    Width = 1019
    Height = 76
  ...
  object popEliminar: TPopupMenu
    ...
    object ReciboControlado1: TMenuItem
      Caption = 'Marcar Anomalia como  Controlada'
      OnClick = ReciboControlado1Click
    end
    object N2: TMenuItem
      Caption = '-'
    end
    object Seleccionartodas1: TMenuItem
      Caption = 'Seleccionar todas'
      OnClick = Seleccionartodas1Click
    end
    object DeseleccionarTodas1: TMenuItem
      Caption = 'Deseleccionar Todas'
      OnClick = DeseleccionarTodas1Click
    end
  end
end
