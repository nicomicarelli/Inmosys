object fCambioAlquiler: TfCambioAlquiler
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = 'Movimientos - Cambio Alquiler'
  ClientHeight = 117
  ClientWidth = 702
  Color = clSilver
  ...
  object Panel2: TPanel
    ...
    TabOrder = 1
    ExplicitTop = 81
    object chCambiar: TCheckBox
      Left = 112
      Top = 12
      Width = 233
      Height = 17
      Caption = 'Cambiar por Art'#237'culo 7mo. contrato locaci'#243'n'
      TabOrder = 0
      OnClick = chCambiarClick
    end
