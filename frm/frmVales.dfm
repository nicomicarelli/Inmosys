object FVales: TFVales
  ...
  object popEliminar: TPopupMenu
    ...
    object Cambiaritemal27: TMenuItem
      Caption = 'Cambiar item al 27'
      OnClick = Cambiaritemal27Click
    end
    object CambiarItemal9: TMenuItem
      Caption = 'Cambiar Item al 9'
      OnClick = CambiarItemal9Click
    end
  end
