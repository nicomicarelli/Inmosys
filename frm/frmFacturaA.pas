...
uses
  ...
  CheckLst, FXQuery, IBTable, IBCustomDataSet,
...
procedure TFFacturaA.FormClose(Sender: TObject;
...
procedure TFFacturaA.FormCreate(Sender: TObject);
var
  q: TFXQuery;
begin
...
procedure TFFacturaA.gListaGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
  if ARow > 0 then
  case ACol of
...
function TFFacturaA.plTituloGetFieldValue(aFieldName: string)
  : Variant;
begin
  ...
  else if aFieldName = 'TotalIVA' then
    Result := gImpresion.Cells[10, 1]
  else if aFieldName = 'Subtotal' then
    Result := gImpresion.Cells[14, 1];


end;

procedure TFFacturaA.FormActivate(Sender: TObject);
var
  J: Integer;
  q: TFXQuery;
begin
...
procedure TFFacturaA.Edit1KeyPress(Sender: TObject; var Key: Char);
var
  Codigo:      string;
  I:           Integer;
  q: TFXQuery;
...
procedure TFFacturaA.Edit6KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
...
procedure TFFacturaA.Edit7KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
begin
  Fecha := Edit7.Text;
...
procedure TFFacturaA.Edit8KeyPress(Sender: TObject; var Key: Char);
var
  Fecha: string;
  Dia: string;
  Mes: string;
...
procedure TFFacturaA.Edit2KeyPress(Sender: TObject; var Key: Char);
var
 q: TFXQuery;
 Tecla: Char;
begin
...
procedure TFFacturaA.Edit5KeyPress(Sender: TObject; var Key: Char);
var
  Codigo: string;
  Fecha:  string;
  Hoy:    string;
...
procedure TFFacturaA.Edit5PropertiesChange(Sender: TObject);
var
  Codigo: string;
  Fecha:  string;
  Hoy:    string;
...
procedure TFFacturaA.Edit10KeyPress
...
procedure TFFacturaA.Edit4KeyPress(Sender: TObject; var Key: Char);
var
  I: Integer;
var
  q: TFXQuery;
...
procedure TFFacturaA.BitBtn1Click(Sender: TObject);
begin
  gDetalle.Vaciar;
  actCalcularComisiones.Execute;
end;

procedure TFFacturaA.BitBtn5Click(Sender: TObject);
var
  I: Integer;
...
procedure TFFacturaA.btnGrabarClick(Sender: TObject);
var
  q: TFXQuery;
  I: Integer;
  Valor: Double;
...
procedure TFFacturaA.btnSalirClick(Sender: TObject);
begin
  Close;
end;

procedure TFFacturaA.actRecibosExecute(Sender: TObject);
var
  Fecha: string;
  Importe: string;
  q: TFXQuery;
...
procedure TFFacturaA.actCalcularComisionesExecute(Sender: TObject);
var
  Propietario: string;
  Inq: string;
  pro: string;
