object FRazonesSociales: TFRazonesSociales
  Left = 621
  Top = 173
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Inmosys - Gesti'#243'n de Razones Sociales'
  ClientHeight = 180
  ClientWidth = 461
  Color = clSilver
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    object edtPorcentaje: TEdit
      ...
      ParentCtl3D = False
      TabOrder = 4
      OnKeyPress = edtPorcentajeKeyPress
    end
    object edCuentaBancaria: TEdit
      Left = 128
      Top = 115
      Width = 297
      Height = 21
