object fBackupDatos: TfBackupDatos
  Left = 0
  Top = 0
  ...
  object lblCodigo: TLabel
    ...
    Width = 233
    Height = 14
    Caption = 'El backup se generar'#225' en la siguiente ruta:'
  ...
  object DiscoExterno: TCheckDirectoryListBoxEx
    Left = 488
    Top = 111
    Width = 259
    Height = 274
  ...
  object Disco: TDriveComboBox
    Left = 487
    Top = 80
    Width = 260
    Height = 25
    DirList = DiscoExterno
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -16
    Font.Name = 'Tahoma'
